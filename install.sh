...
sudo apt install -y git rxvt-unicode snapd volumeicon-alsa blueman network-manager-gnome neofetch polybar rofi ; 
...
mv dotfiles/.local/share/aliases ~/.local/share/aliases ;
mv dotfiles/.local/share/polybar ~/.local/share/polybar ;
